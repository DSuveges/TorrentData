...
```{r raw_genres_test }
# Get information about the diversity of the source data:
# Number of torrens uncovered:
...
cat("Number of torrent files:", TorrentNumber,
    ...
    "\nThat is", UnAssignedRatio, "percent of the total torrent population.")
```
...
# get the number of torrents covered by the top 100 genre (external Perl script):
...
treemap(
    ...
    vColor = "colors",  # Colum name with color definitions
